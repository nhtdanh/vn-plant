...
// @ts-nocheck 
/*
 * This file exports the `TaxonExternalId` model and its related types.
 *
...
export type GetTaxonExternalIdAggregateType<T extends TaxonExternalIdAggregateArgs> = {
      [P in keyof T & keyof AggregateTaxonExternalId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTaxonExternalId[P]>
    : Prisma.GetScalarType<T[P], AggregateTaxonExternalId[P]>
}
...
type GetTaxonExternalIdGroupByPayload<T extends TaxonExternalIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TaxonExternalIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TaxonExternalIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TaxonExternalIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TaxonExternalIdGroupByOutputType[P]>
      }
    >
  >
...
export type TaxonExternalIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TaxonExternalIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TaxonExternalIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TaxonExternalId'], meta: { name: 'TaxonExternalId' } }
  /**
   ...
   * })
  **/
  count<T extends TaxonExternalIdCountArgs>(
    args?: Prisma.Subset<T, TaxonExternalIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TaxonExternalIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TaxonExternalIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TaxonExternalIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTaxonExternalIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
