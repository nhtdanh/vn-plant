...
// @ts-nocheck 
/*
 * This file exports the `TaxonImage` model and its related types.
 *
...
export type GetTaxonImageAggregateType<T extends TaxonImageAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTaxonImage[P]>
    : Prisma.GetScalarType<T[P], AggregateTaxonImage[P]>
}
...
type GetTaxonImageGroupByPayload<T extends TaxonImageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TaxonImageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TaxonImageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TaxonImageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TaxonImageGroupByOutputType[P]>
      }
    >
  >
...
export type TaxonImageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface TaxonImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends TaxonImageCountArgs>(
    args?: Prisma.Subset<T, TaxonImageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TaxonImageCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, TaxonImageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTaxonImageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
