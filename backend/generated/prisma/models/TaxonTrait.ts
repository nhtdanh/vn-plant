...
// @ts-nocheck 
/*
 * This file exports the `TaxonTrait` model and its related types.
 *
...
export type GetTaxonTraitAggregateType<T extends TaxonTraitAggregateArgs> = {
      [P in keyof T & keyof AggregateTaxonTrait]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTaxonTrait[P]>
    : Prisma.GetScalarType<T[P], AggregateTaxonTrait[P]>
}
...
type GetTaxonTraitGroupByPayload<T extends TaxonTraitGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TaxonTraitGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TaxonTraitGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TaxonTraitGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TaxonTraitGroupByOutputType[P]>
      }
    >
  >
...
export type TaxonTraitCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TaxonTraitFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TaxonTraitDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TaxonTrait'], meta: { name: 'TaxonTrait' } }
  /**
   ...
   * })
  **/
  count<T extends TaxonTraitCountArgs>(
    args?: Prisma.Subset<T, TaxonTraitCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TaxonTraitCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TaxonTraitGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TaxonTraitGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTaxonTraitGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
